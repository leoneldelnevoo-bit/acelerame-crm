...
export const PROJECTS = {
  ...
  poncho: {
    ...
    brand: 'Sukhafé',
    color: '#7ea584',
    supabaseUrl: 'https://ntmoehzdqvbvcgnoxxpp.supabase.co',
    supabaseKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im50bW9laHpkcXZidmNnbm94eHBwIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3Njk1NDU4MSwiZXhwIjoyMDkyNTMwNTgxfQ.-LuuKh4NQSDwwLR-3szaliHIpngZvY9Us-kcg0FM32Q',
